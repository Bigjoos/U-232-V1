...
if (isset($_GET['remove']))
{
    ...
    fclose($filenum);
    header("Location: {$TBDEV['baseurl']}/staffpanel.php?tool=freeleech");
    die;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $fl['expires'] = (isset($_POST['expires']) ? ($_POST['expires'] * 86400 + time()) : false);
...
} else
{
    ...
    foreach ($free as $fl)
    {
        ...
        $HTMLOUT .= "<tr><td>$mode
            ...
            'DATE')." (".mkprettytime($fl['expires'] - time())." to go)" : 'Unlimited').
            " </td>
