...
<td valign='middle' width='10%'><center><b>{$running_total}</b></center></td>
		...
		print stdhead($page_title) . $htmlout . stdfoot();
...
function main_screen($mode='reg'){
    ...
    {$menu}
    <form action='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra' method='post' name='StatsForm'>
    <input name='mode' value='{$form_code}' type='hidden' />

	
    <div style='text-align: left; width: 50%; border: 1px solid blue; padding: 5px;'>
		<div style='background: lightgrey; height: 25px; margin-bottom:20px;'>
...
function make_side_menu() {
    ...
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=reg' style='text-decoration: none;'>Registration Stats</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=topic' style='text-decoration: none;'>New Topic Stats</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=post' style='text-decoration: none;'>Post Stats</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=msg' style='text-decoration: none;'>Personal Message</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=views' style='text-decoration: none;'>Topic Views</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=comms' style='text-decoration: none;'>Comment Stats</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=torrents' style='text-decoration: none;'>Torrents Stats</a></div>
    <div align='left'>&nbsp;&nbsp;<a href='{$TBDEV['baseurl']}/staffpanel.php?tool=stats_extra&amp;action=stats_extra&amp;mode=reps' style='text-decoration: none;'>Reputation Stats</a></div>
</div>";
