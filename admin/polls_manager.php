...
function delete_poll() {
    ...
    if( !isset($_GET['sure']) )
      ...
      <a href='javascript:history.back()' title='Cancel this operation!' style='color:green;font-weight:bold'><span class='btn' style='padding:3px;'><img style='vertical-align:middle;' src='{$TBDEV['pic_base_url']}/polls/p_delete.gif' alt='Go Back' />Go Back</span></a>&nbsp;<a href=staffpanel.php?tool=polls_manager&amp;'action=polls_manager&amp;mode=delete&amp;pid={$pid}&amp;sure=1' title='Delete this poll, there is no going back!' style='color:green;font-weight:bold'><span class='btn' style='padding:3px;'><img style='vertical-align:middle;' src='{$TBDEV['pic_base_url']}/polls/p_tick.gif' alt='Delete' />Delete Sure?</span></a>");
...
function update_poll() {
    ...
    else
    {
      ...
      <a href='staffpanel.php?tool=polls_manager&amp;action=polls_manager' title='Return to Polls Manager' style='color:green;font-weight:bold'><span class='btn' style='padding:3px;'><img style='vertical-align:middle;' src='{$TBDEV['pic_base_url']}/polls/p_tick.gif' alt='Success' />Success</span></a>";
    }
...
function show_poll_archive() {
    ...
    { 
      ...
      <br />
      <a href='staffpanel.php?tool=polls_manager&amp;action=polls_manager&amp;mode=new'><span class='btn' style='padding:3px;' title='Add a new poll'><img style='vertical-align:top;' src='{$TBDEV['pic_base_url']}/polls/p_add.gif' alt='Add New' />&nbsp;Add New Poll</span></a>";
    }
    else
    {
      ...
      while( $row = mysql_fetch_assoc($query) ) 
      {
        ...
        $HTMLOUT .= "<tr>
          ...
          <td><a href='staffpanel.php?tool=polls_manager&amp;action=polls_manager&amp;mode=edit&amp;pid={$row['pid']}'><span class='btn' title='Edit poll'><img style='vertical-align:middle;' src='{$TBDEV['pic_base_url']}/polls/p_edit.gif' alt='Edit' />&nbsp;Edit</span></a>&nbsp;
          <a href='staffpanel.php?tool=polls_manager&amp;action=polls_manager&amp;mode=delete&amp;pid={$row['pid']}'><span class='btn' title='Delete poll'><img style='vertical-align:middle;' src='{$TBDEV['pic_base_url']}/polls/p_delete.gif' alt='Delete' />&nbsp;Delete</span></a></td>
        </tr>";
