...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  isset($_POST['sure']) && $sure = htmlspecialchars($_POST['sure']);
  if (!$sure)
  ...
  $res1 = sql_query("INSERT INTO messages (sender, poster, receiver, subject, msg, added) VALUES (0, 0, $CURUSER[id], ".sqlesc($subject).", ".sqlesc($msg).", '".time()."')") or sqlerr(__FILE__, __LINE__);
...
print stdhead("Ten Percent") . $HTMLOUT . stdfoot();
?>