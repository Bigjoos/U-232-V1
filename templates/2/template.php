...
function stdhead($title = "", $msgalert = true, $stdhead = false) {
    ...
    <body>
      ...
      <a href='javascript:void(0)' onclick='status_showbox()'>Update status</a>
      </div>
...
////////////// REP SYSTEM END //////////
    ...
    $usrclass = "&nbsp;<a href='{$TBDEV['baseurl']}/setclass.php'><b>(".get_user_class_name($CURUSER['class']).")</b></a>&nbsp;";
	  $StatusBar = '';
		...
		&nbsp;&nbsp;Bonus:&nbsp;<a href='{$TBDEV['baseurl']}/mybonus.php'>{$CURUSER['seedbonus']}</a>&nbsp;&nbsp;<a href='#' onclick='themes();'>[Theme]</a>&nbsp;"
