...
function stdhead($title = "", $msgalert = true, $stdhead = false) {
    ...
    {
    $htmlout .= "<a href='#' onclick='themes();'>[Theme]</a>&nbsp;|<a href='javascript:void(0)' onclick='status_showbox()'>[Update status]</a>&nbsp;|&nbsp;<a href='./viewrequests.php'>{$lang['gl_request']}</a>&nbsp;|&nbsp;<a href='./credits.php'>{$lang['gl_credits']}</a>&nbsp;|&nbsp;<a href='./staffpanel.php'>{$lang['gl_admin']}</a>&nbsp;|&nbsp;";
    }
...
<br />' : '');
   ...
   <tr><td style='padding: 10px; background: #A60A15'>\n
