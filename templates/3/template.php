...
function stdhead($title = "", $msgalert = true, $stdhead = false) {
    ...
    <table width='902' cellspacing='0' cellpadding='0' style='background: transparent' align='center'>
	  ...
	  $htmlout .="&nbsp;<a href='#' onclick='themes();'>[Theme]</a>&nbsp;|&nbsp;<a href='javascript:void(0)' onclick='status_showbox()'>[Update status]</a>&nbsp;|&nbsp;<a href='./getrss.php'>{$lang['gl_getrss']}</a>&nbsp;|&nbsp;<a href='./contactstaff.php'>{$lang['gl_help']}</a>&nbsp;|&nbsp;<a href='./viewrequests.php'>{$lang['gl_request']}</a>&nbsp;|&nbsp;<a href='./usercp.php'>{$lang['gl_profile']}</a>&nbsp;|&nbsp;<a href='./donate.php'>{$lang['gl_donate']}</a>&nbsp;|&nbsp;<a href='./logout.php'>{$lang['gl_logout']}</a></td>
	 	</tr>
	 	<tr><td class='clear'>
    ...
    <table class='mainouter' width='902' border='0' cellspacing='0' cellpadding='0' align='center'>
...
global $querytime, $CURUSER, $TBDEV, $q, $queries, $query_stat, $mc1;
    ...
    $htmlfoot .="<div id='newfooter'>
	  <b><a href='./bet.php'>Bets</a>&nbsp;|&nbsp;<a href='./chat.php'>Chat</a>&nbsp;|&nbsp;<a href='./topten.php'>Top10</a>&nbsp;|&nbsp;<a href='./links.php'>Links</a></b>
...
function StatusBar() {
  ...
  //==End
	//==Memcached Seed/Leech/Connectable
    ...
    $max = 999;
      ...
      $usrclass = "&nbsp;<a href='./setclass.php'><b>(".get_user_class_name($CURUSER['class']).")</b></a>&nbsp;";
	    ...
	    ."&nbsp;
			...
			."&nbsp;&nbsp;{$lang['gl_act_torrents']}:&nbsp;<img alt='{$lang['gl_seed_torrents']}' title='{$lang['gl_seed_torrents']}' src='./templates/3/theme/up.png' />&nbsp;{$seed['yes']}".
