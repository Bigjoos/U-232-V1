...
////////////// REP SYSTEM END //////////
    ...
    {$lang['gl_msg_welcome']}, ".format_username($CURUSER)."&nbsp;{$usrclass}&nbsp;$member_reputation
		...
		&nbsp;|"
		."&nbsp;&nbsp;<a href='./messages.php'>$inbox</a>&nbsp;|&nbsp;<a href='#' onclick='themes();'>[Theme]</a>&nbsp;|&nbsp;<a href='javascript:void(0)' onclick='status_showbox()'>[Update status]</a>&nbsp;|&nbsp;[<a href='./logout.php'><b>{$lang['gl_logout']}</b></a>]&nbsp;
    </div>";
	return $StatusBar;
