...
function stdhead($title = "", $msgalert = true, $stdhead = false) {
    ...
    <title>{$title}</title>
	  <link rel='shortcut icon' href='favicon.ico' />
          <link rel='stylesheet' href='templates/8/8.css' type='text/css' />
  ...
  <tr>
	<td class='border0'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
  <tr>
	<td style='width: 70px; background-image: url(templates/8/story/story_01.gif)' height='47' class='border0'></td>
	<td  height='47' style='background-image: url(templates/8/story/story_02.gif)' class='border0'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
	<td class='border0'><!--<font class='storytitle'><div style='padding-bottom:1px;'><strong>&nbsp;&nbsp;test-->";
    ...
    {
      $htmlout .= "<span style='align:right;'>
      <a href='./login.php'>{$lang['gl_login']}</a>
      <a href='./signup.php'>{$lang['gl_signup']}</a>
      <a href='./recover.php'>{$lang['gl_recover']}</a></span>
      ";
    }$htmlout .= "</td>
  </tr>
</table></td>
	<td style='width: 58px; background-image: url(templates/8/story/story_03.gif)' height='47' class='border0'></td>
  </tr>
</table>
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
	<td style='width: 21px; background-image: url(templates/8/story/story_06.gif)' class='border0'><img src='templates/8/story/story_06.gif' width='21' height='2' alt='' /></td>
	<td bgcolor='#1C2C39' class='border0'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
 <tr>
	<td align='center' width='20%' class='border0'>";
  $htmlout .= StatusBar();
	$htmlout .= "";
	$htmlout .= "</td>
  </tr>
  </table></td>
	<td style='width: 21px; background-image: url(templates/8/story/story_08.gif)' class='border0'><img src='templates/8/story/story_08.gif' width='21' height='2' alt='' /></td>
  </tr>
</table>
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  <tr>
	<td width='32' class='border0'><img src='templates/8/story/story_09.gif' width='32' height='36' alt='' /></td>
	<td height='36' style='width: 100%; background-image: url(templates/8/story/story_10.gif)' class='border0'></td>
	<td width='31' class='border0'><img src='templates/8/story/story_11.gif' width='31' height='36' alt='' /></td>
	</tr>
</table>
	</td>
	</tr>
</table><br />
	<table width='85%' align='center' border='0' cellspacing='0' cellpadding='0' class='border0'>
      <tr>
        <td class='border0'><table width='100%' border='0' cellspacing='0' cellpadding='0' class='border0'>
          <tr>
            <td width='32' height='34' class='border0'><img src='templates/8/tables/tables_01.gif' alt='' width='32' height='34' class='border0' /></td>
            <td style='background-image: url(templates/8/tables/tables_02.gif)' class='border0'><img src='templates/8/tables/spacer.gif' alt='' width='1' height='1' class='border0' /></td>
            <td width='32' height='34' class='border0'><img src='templates/8/tables/tables_03.gif' alt='' width='32' height='34' class='border0' /></td>
          </tr>
        </table>
          <table width='100%' border='0' cellspacing='0' cellpadding='0' class='border0'>
            <tr>
              <td width='32' style='background-image: url(templates/8/tables/tables_04.gif)' class='border0'><img src='templates/8/tables/spacer.gif' alt='' width='1' height='1' /></td>
            <td style='background-color: #1c2c39;' class='border0'>
			<!--<table width='90%' align='center' cellspacing='0' cellpadding='0' style='background: transparent'>
      <tr>
      <td class='clear'>
      <div id='logostrip'>
      ...
      <table class='mainouter' width='97%' align='center' border='1' cellspacing='0' cellpadding='10'>
...
function stdfoot($stdfoot = false) {
    ...
    $htmlfoot='';
    if(isset($CURUSER)){
    $htmlfoot = "<br /><div class='roundedCorners' style='text-align:left;width:80%;border:1px solid black;padding:5px;'>
    ...
    They had to raid the server ".$queries." time'".$howmany."using&nbsp;:&nbsp;<b>".$percentphp."</b>&nbsp;&#37;&nbsp;php&nbsp;&#38;&nbsp;<b>".$percentsql."</b>&nbsp;&#37;&nbsp;sql ".$serverkillers.".<br />".$header."</span></p></div></div><br />";
   ...
   <td width='32' style='background-image: url(templates/8/tables/tables_06.gif)' class='border0'><img src='templates/8/tables/spacer.gif' alt='' width='1' height='1' class='border0' /></td>
            </tr>
          </table>
          <table width='100%' border='0' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='32' height='35' class='border0'><img src='templates/8/tables/tables_07.gif' alt='' width='32' height='35' class='border0' /></td>
              <td style='background-image: url(templates/8/tables/tables_08.gif)' class='border0'><img src='templates/8/tables/spacer.gif' alt='' width='1' height='1' class='border0' /></td>
              <td width='32' class='border0'><img src='templates/8/tables/tables_09.gif' alt='' width='32' height='35' class='border0' /></td>
            </tr>
          </table>
      </td>
      </tr>
...
<center>
	<div class='table_border'>
	                        <center>
							      ...
							      <a href='http://www.tbdev.net'><img src='{$TBDEV['pic_base_url']}tbdev_btn_red.png' border='0' alt='Powered By TBDev &copy;2009' title='Powered By TBDev &copy;2009' /></a>
								  <a href=''><img src='{$TBDEV['pic_base_url']}xhtml_valid.png' border='0' alt='' title='' /></a>
								  <a href=''><img src='{$TBDEV['pic_base_url']}css_valid.png' border='0' alt='' title='' /></a>
								  <a href='http://www.utorrent.com/downloads'><!---<img src='{$TBDEV['pic_base_url']}utorrent.png' border='0' alt='download utorrent' title='download utorrent' />--></a>
						   </center>
	</div>
</center>
	<br />
...
//	break;
    ...
    $usrclass = "&nbsp;<a href='{$TBDEV['baseurl']}/setclass.php'><b>(".get_user_class_name($CURUSER['class']).")</b></a>&nbsp;";
	  $StatusBar = '';
		$StatusBar = 
		"<div id='statusbar' class='table_border1'>".
		...
		&nbsp;&nbsp;Bonus:&nbsp;<a href='{$TBDEV['baseurl']}/mybonus.php'>{$CURUSER['seedbonus']}</a>&nbsp;<a href='#' onclick='themes();'>Theme</a>&nbsp;&nbsp;<a href='javascript:void(0)' onclick='status_showbox()'>Update status</a>&nbsp;"."
