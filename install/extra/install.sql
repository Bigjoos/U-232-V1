...
-- 
-- Host: localhost
-- Generation Time: Oct 11, 2010 at 07:34 PM
...
INSERT INTO `avps` VALUES ('loadlimit', '6.1534-1286155739', 0, 0);
...
INSERT INTO `bonus` VALUES (3, '5GB Uploaded', 550.0, 'With enough bonus points acquired, you are able to exchange them for an Upload Credit. The points are then removed from your Bonus Bank and the credit is added to your total uploaded amount.', 'traffic', 5368709120, 1.0, 'yes', 550);
...
INSERT INTO `bonus` VALUES (6, 'VIP Status', 5000.0, 'With enough bonus points acquired, you can buy yourself VIP status for one month. The points are then removed from your Bonus Bank and your status is changed.', 'class', 1, 1.0, 'no', 5000);
INSERT INTO `bonus` VALUES (7, 'Give A Karma Gift', 100.0, 'Well perhaps you dont need the upload credit, but you know somebody that could use the Karma boost! You are now able to give your Karma credits as a gift! The points are then removed from your Bonus Bank and added to the account of a user of your choice!\r\n\r\nAnd they recieve a PM with all the info as well as who it came from...', 'gift_1', 1073741824, 1.0, 'yes', 100);
...
INSERT INTO `bonus` VALUES (9, 'Remove Warning', 1000.0, 'With enough bonus points acquired... So you have been naughty... tsk tsk :P Yep now for the Low Low price of only 1000 points you can have that warning taken away lol.!', 'warning', 1, 1.0, 'yes', 1000);
...
INSERT INTO `bonus` VALUES (16, '5GB Download Removal', 500.0, 'With enough bonus points acquired, you are able to exchange them for a Download Credit Removal. The points are then removed from your Bonus Bank and the download credit is removed from your total downloaded amount.', 'traffic2', 5368709120, 1.0, 'no', 500);
...
INSERT INTO `forums` VALUES (0, 1, 'Testing Bunny Forum', 'Test forums', 0, 0, 0, 0, 0, 0, 1);
...
INSERT INTO `forum_config` VALUES (13, 1, 4, 7, 0, 'a:5:{i:0;s:3:"zip";i:1;s:3:"rar";i:2;s:3:"gif";i:3;s:3:"png";i:4;s:0:"";}', 'a:3:{i:0;s:15:"application/zip";i:1;s:15:"application/rar";i:2;s:0:"";}', 2097152, 'uploads/');
...
CREATE TABLE `iplog` (
  ...
  `warnpm` int(11) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `userid` (`userid`),
  KEY `ip` (`ip`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `lottery_config` VALUES ('ticket_amount', '1000');
...
INSERT INTO `lottery_config` VALUES ('total_winners', '3');
INSERT INTO `lottery_config` VALUES ('prize_fund', '10000000');
INSERT INTO `lottery_config` VALUES ('start_date', '1284884188');
INSERT INTO `lottery_config` VALUES ('end_date', '1285476388');
...
INSERT INTO `over_forums` VALUES (1, 'Testing Bunny Forum', 'Test forums', 0, 0);
...
INSERT INTO `searchcloud` VALUES (1, 'teste', 25);
INSERT INTO `searchcloud` VALUES (2, 'test', 41);
INSERT INTO `searchcloud` VALUES (3, 'look', 3);
INSERT INTO `searchcloud` VALUES (4, 'testing again', 1);
INSERT INTO `searchcloud` VALUES (5, 'testes', 1);
...
INSERT INTO `stylesheets` VALUES (1, 'itunes.css', 'Itunes');
